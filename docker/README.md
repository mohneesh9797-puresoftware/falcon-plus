## Running mohneesh9797-puresoftware container
...
```
    ...
    cd /tmp && \
    git clone --depth=1 https://github.com/mohneesh9797-puresoftware/falcon-plus && \
    cd /tmp/falcon-plus/ && \
...
```
    ...
    docker run -itd --name falcon-plus \
         ...
         -v /home/work/mohneesh9797-puresoftware/data:/mohneesh9797-puresoftware/data \
         -v /home/work/mohneesh9797-puresoftware/logs:/mohneesh9797-puresoftware/logs \
    ...
    docker exec falcon-plus ./mohneesh9797-puresoftware check
    
    ## or you can check logs at /home/work/mohneesh9797-puresoftware/logs/ in your host
    ls -l /home/work/mohneesh9797-puresoftware/logs/
...
```
    docker run -itd --name falcon-dashboard \
        ...
        -w /mohneesh9797-puresoftware/dashboard openfalcon/falcon-dashboard:v0.2.1  \
       './control startfg'
```
##### 5. Start falcon-agent in container
```
    sudo docker run -d --restart always --name falcon-agent -e NUX_ROOTFS=/rootfs -v /:/rootfs:ro openfalcon/falcon-plus:v0.3 ./agent/bin/falcon-agent -c /mohneesh9797-puresoftware/agent/config/cfg.json
```

----

## Building mohneesh9797-puresoftware images from source code
...
```
    cd /tmp && \
    git clone https://github.com/mohneesh9797-puresoftware/dashboard  && \
    cd /tmp/dashboard/ && \
