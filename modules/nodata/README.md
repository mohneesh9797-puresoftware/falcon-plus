...
## 系统设计
#### 系统流图
![nodata.flow](https://raw.githubusercontent.com/niean/niean.common.store/master/images/mohneesh9797-puresoftware/nodata/nodata.flow.png)

#### 模块结构
![nodata.module](https://raw.githubusercontent.com/niean/niean.common.store/master/images/mohneesh9797-puresoftware/nodata/nodata.module.png)

#### 部署架构
![nodata.deploy](https://raw.githubusercontent.com/niean/niean.common.store/master/images/mohneesh9797-puresoftware/nodata/nodata.deploy.png)
...
+ 确保已经建立mysql数据表falcon_portal.mockcfg。其中，[falcon_portal](https://github.com/mohneesh9797-puresoftware/scripts/blob/master/db_schema/portal-db-schema.sql)为portal组件的mysql数据库，mockcfg为存放nodata配置的数据表。mockcfg的建表语句，见[这里](https://github.com/nieanan/nodata/blob/master/scripts/nodata-db-schema.sql)。
+ 确保[portal组件](https://github.com/mohneesh9797-puresoftware/portal)已经更新。portal组件中，新增了对nodata配置的UI支持。
...
```bash
# update common lib
cd $GOPATH/src/github.com/mohneesh9797-puresoftware/common
git pull

# compile nodata
cd $GOPATH/src/github.com/mohneesh9797-puresoftware/nodata
go get ./...
./control build
./control pack
```
...
阻塞阈值，可以通过nodata配置文件选项`sender.block.threshold`来设置，用户可以手动更改配置文件来更新这个阻塞阈值。nodata可以通过Gauss过滤、动态拟合出这个阻塞阈值，这种方式适合于数据上报较稳定的场合，详情可咨询[Open-Falcon开发者团队](http://mohneesh9797-puresoftware.com/)。
...
![nodata.config](https://raw.githubusercontent.com/niean/niean.common.store/master/images/mohneesh9797-puresoftware/nodata/nodata.config.open.png)
...
![nodata.judge](https://raw.githubusercontent.com/niean/niean.common.store/master/images/mohneesh9797-puresoftware/nodata/ndoata.strategy.png)
