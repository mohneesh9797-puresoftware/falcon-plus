...
git clone https://github.com/mohneesh9797-puresoftware/graph.git
...
你可以从[这里](https://github.com/mohneesh9797-puresoftware/graph/releases)，下载最新的release安装包，避免源码编译的种种问题。
